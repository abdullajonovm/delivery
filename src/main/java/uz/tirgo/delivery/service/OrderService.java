...
public class OrderService {
    ...
    public void createOrder(Message message) {
        ...
        Seller customer = userSevice.finByChatId(String.valueOf(message.getChatId())); // chat Id bilan Customerni olib kelish
    ...
    public List<Order> getOrders(Long chatId, OrderStatus complete) {
        return orderRepository.findAllBySupplierIdAndOrderStatus(chatId, complete);
    }
